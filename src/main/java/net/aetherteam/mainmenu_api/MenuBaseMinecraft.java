...
public class MenuBaseMinecraft extends MenuBase
{
    ...
    public void initGui()
    {
        ...
        this.fmlModButton = new GuiButton(6, this.height / 2 - 100, i + 48, "Mods");
        this.k.add(this.fmlModButton);
        func_96137_a(stringtranslate, i, 24);

        if (this.g.hideQuitButton)
        {
            this.k.add(new GuiButton(0, this.height / 2 - 100, i + 72, stringtranslate.translateKey("menu.options")));
        }
        else
        {
            this.k.add(new GuiButton(0, this.height / 2 - 100, i + 72 + 12, 98, 20, stringtranslate.translateKey("menu.options")));
            this.k.add(new GuiButton(4, this.height / 2 + 2, i + 72 + 12, 98, 20, stringtranslate.translateKey("menu.quit")));
        }
    ...
    private void func_98060_b(StringTranslate par1StringTranslate, int par2, int par3)
    {
        ...
        GuiButton realmButton = new GuiButton(3, this.height / 2 - 100, par2 + par3 * 2, par1StringTranslate.translateKey("menu.online"));
    ...
    {
        this.k.add(new GuiButton(1, this.height / 2 - 100, par1, par3StringTranslate.translateKey("menu.singleplayer")));
        this.k.add(new GuiButton(2, this.height / 2 - 100, par1 + par2 * 1, par3StringTranslate.translateKey("menu.multiplayer")));
    }

    private void addDemoButtons(int par1, int par2, StringTranslate par3StringTranslate)
    {
        this.k.add(new GuiButton(11, this.height / 2 - 100, par1, par3StringTranslate.translateKey("menu.playdemo")));
        this.k.add(this.buttonResetDemo = new GuiButton(12, this.height / 2 - 100, par1 + par2 * 1, par3StringTranslate.translateKey("menu.resetdemo")));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.g.renderEngine.b("/title/mclogo.png");
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(this.height / 2 + 90, 70.0F, 0.0F);
        ...
        for (int i = 0; i < brandings.size(); i++)
        {
            ...
            {
                drawString(this.m, brd, 2, this.i - (10 + i * (this.m.FONT_HEIGHT + 1)), 16777215);
            }
        }

        String s1 = "Copyright Mojang AB. Do not distribute!";
        drawString(this.m, s1, this.height - this.m.getStringWidth(s1) - 2, this.i - 10, 16777215);

        if ((this.field_92025_p != null) && (this.field_92025_p.length() > 0))
        {
            drawRect(this.field_92022_t - 2, this.field_92021_u - 2, this.field_92020_v + 2, this.field_92019_w - 1, 1428160512);
            drawString(this.m, this.field_92025_p, this.field_92022_t, this.field_92021_u, 16777215);
            drawString(this.m, field_96138_a, (this.height - this.field_92024_r) / 2, ((GuiButton)this.k.get(0)).yPosition - 12, 16777215);
        }
