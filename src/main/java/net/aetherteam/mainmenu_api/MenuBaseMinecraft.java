...
public class MenuBaseMinecraft extends MenuBase
{
    ...
    public MenuBaseMinecraft()
    {
        ...
        try
        {
            ...
            var1 = new BufferedReader(new InputStreamReader(MenuBaseMinecraft.class.getResourceAsStream("/title/splashes.txt"), Charset.forName("UTF-8")));
            String var3;
    ...
    public void initGui()
    {
        ...
        this.fmlModButton = new GuiButton(6, this.width / 2 - 100, var3 + 48, "Mods");
    ...
    private void func_98060_b(StringTranslate var1, int var2, int var3)
    {
        ...
        GuiButton var4 = new GuiButton(3, this.width / 2 - 100, var2 + var3 * 2, var1.translateKey("menu.online"));
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        for (int var11 = 0; var11 < var10.size(); ++var11)
        {
            ...
            {
                this.drawString(this.fontRenderer, var12, 2, this.height - (10 + var11 * (this.fontRenderer.FONT_HEIGHT + 1)), 16777215);
            }
        }

        String var13 = "Copyright Mojang AB. Do not distribute!";
        this.drawString(this.fontRenderer, var13, this.width - this.fontRenderer.getStringWidth(var13) - 2, this.height - 10, 16777215);
    ...
    static Minecraft func_98058_a(MenuBaseMinecraft var0)
    {
        return var0.mc;
    }

    static void func_98061_a(MenuBaseMinecraft var0, StringTranslate var1, int var2, int var3)
    {
