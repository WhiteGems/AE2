...
public class GuiAetherButton extends GuiButton
{
    ...
    public GuiAetherButton(int var1, int var2, int var3, String var4)
    {
    ...
    public GuiAetherButton(int var1, int var2, int var3, int var4, int var5, String var6)
    {
    ...
    public void drawButton(Minecraft var1, int var2, int var3)
    {
        if (this.drawButton)
        {
            ...
            GL11.glBindTexture(GL11.GL_TEXTURE_2D, var1.renderEngine.getTexture("/net/aetherteam/mainmenu_api/icons/aether/buttons.png"));
