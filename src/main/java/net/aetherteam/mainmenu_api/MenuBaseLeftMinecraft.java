...
public class MenuBaseLeftMinecraft extends MenuBase
{
    ...
    public void initGui()
    {
        ...
        this.viewportTextureLocation = this.mc.renderEngine.func_110578_a("leftmc_background", this.viewportTexture);
        ...
        this.buttonList.add(new GuiButton(0, 30, i + 27 + 12, 200, 20, I18n.func_135053_a("menu.options")));
        this.buttonList.add(new GuiButton(4, 30, i + 27 + 35, 200, 20, I18n.func_135053_a("menu.quit")));
    ...
    private void func_98060_b(int par2, int par3)
    {
        ...
        GuiButton realmButton = new GuiButton(3, 30, par2 - 45 + par3 * 2, I18n.func_135053_a("menu.online"));
    ...
    {
        this.buttonList.add(new GuiButton(1, 30, par1 - 45, I18n.func_135053_a("menu.singleplayer")));
        this.buttonList.add(new GuiButton(2, 30, par1 - 45 + par2 * 1, I18n.func_135053_a("menu.multiplayer")));
    }

    private void addDemoButtons(int par1, int par2)
    {
        this.buttonList.add(new GuiButton(11, 30, par1, I18n.func_135053_a("menu.playdemo")));
        this.buttonList.add(this.buttonResetDemo = new GuiButton(12, 30, par1 - 45 + par2 * 1, I18n.func_135053_a("menu.resetdemo")));
    ...
    static void func_98061_a(MenuBaseLeftMinecraft par0GuiMainMenu, int par2, int par3)
    {
