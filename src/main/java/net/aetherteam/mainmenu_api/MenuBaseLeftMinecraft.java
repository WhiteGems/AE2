...
public class MenuBaseLeftMinecraft extends MenuBase
{
    ...
    public void initGui()
    {
        ...
        {
            this.k.add(new GuiButton(0, 30, i + 27, stringtranslate.translateKey("menu.options")));
        }
        else
        {
            this.k.add(new GuiButton(0, 30, i + 27 + 12, 200, 20, stringtranslate.translateKey("menu.options")));
            this.k.add(new GuiButton(4, 30, i + 27 + 35, 200, 20, stringtranslate.translateKey("menu.quit")));
        }
    ...
    {
        this.k.add(new GuiButton(1, 30, par1 - 45, par3StringTranslate.translateKey("menu.singleplayer")));
        this.k.add(new GuiButton(2, 30, par1 - 45 + par2 * 1, par3StringTranslate.translateKey("menu.multiplayer")));
    }

    private void addDemoButtons(int par1, int par2, StringTranslate par3StringTranslate)
    {
        this.k.add(new GuiButton(11, 30, par1, par3StringTranslate.translateKey("menu.playdemo")));
        this.k.add(this.buttonResetDemo = new GuiButton(12, 30, par1 - 45 + par2 * 1, par3StringTranslate.translateKey("menu.resetdemo")));
