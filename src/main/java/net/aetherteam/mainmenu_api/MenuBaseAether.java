...
{
    private static final ResourceLocation TEXTURE_MC_LOGO_MOD = new ResourceLocation("mainmenu_api", "textures/title/mclogomod1.png");
    ...
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {new ResourceLocation("mainmenu_api", "textures/title/bg/panorama0.png"), new ResourceLocation("mainmenu_api", "textures/title/bg/panorama1.png"), new ResourceLocation("mainmenu_api", "textures/title/bg/panorama2.png"), new ResourceLocation("mainmenu_api", "textures/title/bg/panorama3.png"), new ResourceLocation("mainmenu_api", "textures/title/bg/panorama4.png"), new ResourceLocation("mainmenu_api", "textures/title/bg/panorama5.png")};
    ...
    public void initGui()
    {
        ...
        this.viewportTextureLocation = this.mc.renderEngine.func_110578_a("aether_background", this.viewportTexture);
        ...
        this.buttonList.add(new GuiAetherButton(0, 30, i + 27 + 12, 200, 20, I18n.func_135053_a("menu.options")));
        this.buttonList.add(new GuiAetherButton(4, 30, i + 27 + 35, 200, 20, I18n.func_135053_a("menu.quit")));
    ...
    private void func_98060_b(int par2, int par3)
    {
        ...
        GuiAetherButton realmButton = new GuiAetherButton(3, 30, par2 - 45 + par3 * 2, I18n.func_135053_a("menu.online"));
    ...
    {
        this.buttonList.add(new GuiAetherButton(1, 30, par1 - 45, I18n.func_135053_a("menu.singleplayer")));
        this.buttonList.add(new GuiAetherButton(2, 30, par1 - 45 + par2 * 1, I18n.func_135053_a("menu.multiplayer")));
    }

    private void addDemoButtons(int par1, int par2)
    {
        this.buttonList.add(new GuiAetherButton(11, 30, par1, I18n.func_135053_a("menu.playdemo")));
        this.buttonList.add(this.buttonResetDemo = new GuiAetherButton(12, 30, par1 - 45 + par2 * 1, I18n.func_135053_a("menu.resetdemo")));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        this.mc.renderEngine.func_110577_a(TEXTURE_MC_LOGO_MOD);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        for (int s1 = 0; s1 < brandings.size(); ++s1)
        {
            ...
            {
                this.drawString(this.fontRenderer, brd, this.width - 2 - this.fontRenderer.getStringWidth(brd), this.height - (10 + s1 * (this.fontRenderer.FONT_HEIGHT + 1)), 16777215);
            }
        }
    ...
    static void func_98061_a(MenuBaseAether par0GuiMainMenu, int par2, int par3)
    {
    ...
    {
        return new ResourceLocation("mainmenu_api", "textures/icons/aether/MenuIcon.png");
    }
}
