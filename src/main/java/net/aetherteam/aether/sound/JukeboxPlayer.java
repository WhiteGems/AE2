...
{
    public SoundPoolEntry soundManager = Aether.proxy.getClient().sndManager;
    ...
    private void playMusicFile(String musicFile)
    {
        if ((!JukeboxData.muteMusic) && (isSoundOn()) && (!isMusicPlaying()))
        {
            ...
            this.soundManager.a(musicFile, x != 0.0F ? x : 0.0F, y != 0.0F ? y : 0.0F, z != 0.0F ? z : 0.0F);
        }
    }
    ...
    {
        return (this.soundManager != null) && (SoundPoolEntry.soundName != null);
    }
