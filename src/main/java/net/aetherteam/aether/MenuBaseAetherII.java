...
public class MenuBaseAetherII extends MenuBase
{
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        {
            var22 = (String)var21.get(var11);

            if (!Strings.isNullOrEmpty(var22) && !this.TUGopen)
            {
                this.drawString(this.fontRenderer, var22, this.width - 2 - this.fontRenderer.getStringWidth(var22), this.height - (10 + var11 * (this.fontRenderer.FONT_HEIGHT + 1)), 16777215);
            }
        }
        ...
        Iterator var23;
        GuiAetherIIButton var24;

        if (!this.isJukeboxOpen() && this.SERVERlist)
        {
            for (var23 = this.serverButtons.iterator(); var23.hasNext(); var24.drawButton = true)
            {
                var24 = (GuiAetherIIButton)var23.next();
            }
        ...
        {
            for (var23 = this.serverButtons.iterator(); var23.hasNext(); var24.drawButton = false)
            {
                var24 = (GuiAetherIIButton)var23.next();
            }
