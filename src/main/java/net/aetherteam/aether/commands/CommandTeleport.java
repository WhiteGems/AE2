...
public class CommandTeleport extends CommandBase
{
    ...
    public boolean dungeonCheck(EntityPlayerMP var1, ICommandSender var2, double var3, double var5, double var7)
    {
        ...
        if (var1.dimension == 3)
        {
            ...
            {
                notifyAdmins(var2, "您不能传送 " + var1.username + " 到地牢外面!", new Object[0]);
                return false;
            }

            if (var11 != null && var11.getQueuedParty() != null && var11.getQueuedParty() != var9)
            {
                notifyAdmins(var2, "您不能传送 " + var1.username + " 进入其他地牢!", new Object[0]);
                return false;
            }

            if (var11 != null)
            {
                notifyAdmins(var2, "您不能传送 " + var1.username + " 进入地牢!", new Object[0]);
                return false;
            }
        }
