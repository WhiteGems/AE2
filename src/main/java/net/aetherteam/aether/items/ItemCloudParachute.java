...
public class ItemCloudParachute extends ItemAether
{
    ...
    {
        super(var1); this.maxStackSize = 1; this.setMaxDamage(var2); this.setCreativeTab(Aether.tools);
    }
    ...
    public void onUpdate(ItemStack par1ItemStack, World par2World, Entity par3Entity, int par4, boolean par5)
    {
        ...
        {
            EntityPlayer player = (EntityPlayer)par3Entity; if (player.fallDistance > 20)
        {
            player.fallDistance = 0; if (!par2World.isRemote)
        {
    ...
    public ItemStack onItemRightClick(ItemStack var1, World world, EntityPlayer player)
    {
        ...
        {
            Aether.getServerPlayer(player).setParachuting(true, this.getParachuteType()); --var1.stackSize; return var1;
        }
    }
