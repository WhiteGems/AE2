...
public class ComponentDungeonCorridor extends ComponentDungeonBronzeRoom
{
    ...
    public static StructureBoundingBox findValidPlacement(List par0List, Random par1Random, int par2, int par3, int par4, int par5)
    {
        ...
        for (int var7 = par1Random.nextInt(3) + 2; var7 > 0; var7--)
        {
            int var8 = var7 * 5;
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        fillVariedBlocks(par1World, par3StructureBoundingBox, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ, this.boundingBox.maxX, this.boundingBox.maxY, this.boundingBox.maxZ, AetherBlocks.DungeonHolystone.blockID, 2, AetherBlocks.DungeonHolystone.blockID, 0, 2, par2Random, true);
