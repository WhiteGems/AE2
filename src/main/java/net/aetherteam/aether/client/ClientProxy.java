...
public class ClientProxy extends CommonProxy
{
    ...
    {
        if ((entity instanceof MovementInputFromOptions))
        {
            PlayerBaseAetherClient playerBaseAetherClient = (PlayerBaseAetherClient)((PlayerCoreClient)entity).getPlayerCoreObject(PlayerBaseAetherClient.class);
    ...
    public void registerRenderers()
    {
        ...
        net.aetherteam.aether.blocks.AetherBlocks.berryBushRenderId = RenderingRegistry.getNextAvailableRenderId();
        net.aetherteam.aether.blocks.AetherBlocks.tallAetherGrassRenderId = RenderingRegistry.getNextAvailableRenderId();
    ...
    {
        PlayerCoreAPI.register(PlayerCoreAPI.PlayerCoreType.CLIENT, PlayerBaseAetherClient.class);
    ...
    {
        this.mc.sndManager.a(path, volume, pitch);
    }
    ...
    public void loadSounds()
    {
        ...
        installSound("streaming/Aerwhale.ogg");
        ...
        installSound("newsound/aemob/labyrinthsEye/cogloss.ogg");
        installSound("newsound/aemob/labyrinthsEye/eyedeath.ogg");
        installSound("newsound/aemob/labyrinthsEye/move_1.ogg");
        installSound("newsound/aemob/labyrinthsEye/move_2.ogg");
    }
    ...
    private void installSound(String filename)
    {
        ...
        {
            this.mc.installResource(filename, soundFile);
        }
        else
        {
    ...
    {
        PlayerCoreAPI.register(PlayerCoreAPI.PlayerCoreType.RENDER, RenderPlayerBaseAether.class);
    }
    ...
    public void spawnSwettyParticles(World world, int x, int y, int z)
    {
        ...
        {
            EntityNoteFX particles = new EntityAetherBreakingFX(world, x + this.rand.nextDouble(), y + this.rand.nextDouble(), z + this.rand.nextDouble(), AetherItems.SwettyBall);
            particles.renderDistanceWeight = 10.0D;
            particles.setParticleTextureIndex(143);
            FMLClientHandler.instance().getClient().effectRenderer.a(particles);
        }
    }
    ...
    public void spawnAltarParticles(World world, int x, int y, int z, Random rand)
    {
        ...
        {
            EntityNoteFX particles = new EntityGoldenFX(world, x + rand.nextFloat(), y + (count > particleAmount / 2 ? 0.3F : 0.5F), z + rand.nextFloat(), 0.0D, 1.0D, 0.0D, true);
            FMLClientHandler.instance().getClient().effectRenderer.a(particles);
        }
    }
    ...
    public void spawnCloudSmoke(World world, double x, double y, double z, Random rand, double radius)
    {
        ...
        FMLClientHandler.instance().getClient().effectRenderer.a(new EntityCloudSmokeFX(world, xOffset, yOffset, zOffset, 0.0D, 0.0D, 0.0D, 2.5F, 1.0F, 1.0F, 1.0F));
    }
    ...
    public void spawnCloudSmoke(World world, double x, double y, double z, Random rand, double radius, double forceX, double forceY, double forceZ)
    {
        ...
        double yOffset = y + rand.nextDouble() * radius * 2.0D - radius;
        double zOffset = z + rand.nextDouble() * radius * 2.0D - radius;
        FMLClientHandler.instance().getClient().effectRenderer.a(new EntityCloudSmokeFX(world, xOffset, yOffset, zOffset, forceX, forceY, forceZ, 2.5F, 1.0F, 1.0F, 1.0F));
    }
    ...
    public void spawnDonatorMoaParticles(Entity rider, Random rand)
    {
        for (int count = 0; count < 4; count++)
        {
            ...
            EntityNoteFX particles = new EntityGoldenFX(rider.worldObj, xOffset, yOffset, zOffset, motionX, motionY, motionZ, false);
            FMLClientHandler.instance().getClient().effectRenderer.a(particles);
        }
    }
    ...
    public void spawnPortalParticles(World world, int x, int y, int z, Random random, int blockID)
    {
        for (int l = 0; l < 4; l++)
        {
            ...
            EntityNoteFX obj = new EntityAetherPortalFX(world, xOffset, yOffset, zOffset, motionX, motionY, motionZ);
