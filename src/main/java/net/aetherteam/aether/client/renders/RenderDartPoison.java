...
public class RenderDartPoison extends RenderManager
{
    public void renderDartPoison(EntityDartPoison entitypoisondart, double d, double d1, double d2, float f, float f1)
    {
        ...
        a("/net/aetherteam/aether/client/sprites/projectiles/dart/entitypoisondart.png");
        GL11.glPushMatrix();
        ...
        float f11 = entitypoisondart.arrowShake - f1;
    ...
    {
        renderDartPoison((EntityDartPoison)entity, d, d1, d2, f, f1);
    }
}
