...
{
    public void renderDartEnchanted(EntityDartEnchanted var1, double var2, double var4, double var6, float var8, float var9)
    {
        if (var1.victim == null)
        {
            this.loadTexture("/net/aetherteam/aether/client/sprites/projectiles/dart/entityenchanteddart.png");
            GL11.glPushMatrix();
    ...
    {
        this.renderDartEnchanted((EntityDartEnchanted)var1, var2, var4, var6, var8, var9);
    }
}
