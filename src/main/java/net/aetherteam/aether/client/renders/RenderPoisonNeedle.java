...
public class RenderPoisonNeedle extends RenderManager
{
    public void renderPoisonNeedle(EntityPoisonNeedle entityarrow, double d, double d1, double d2, float f, float f1)
    {
        ...
        a("/net/aetherteam/aether/client/sprites/projectiles/dart/entitypoisonneedle.png");
        GL11.glPushMatrix();
    ...
    {
        renderPoisonNeedle((EntityPoisonNeedle)entity, d, d1, d2, f, f1);
    }
}
