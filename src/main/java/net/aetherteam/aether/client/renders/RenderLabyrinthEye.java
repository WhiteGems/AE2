...
public class RenderLabyrinthEye extends RenderLiving
{
    ...
    protected void renderModel(EntityLiving var1, float var2, float var3, float var4, float var5, float var6, float var7)
    {
        ...
        EntityLabyrinthEye var8 = (EntityLabyrinthEye)var1;
        ((ModelLabyrinthEye)this.mainModel).cogNumber = var8.getStage();
        ...
        GL11.glTranslated(var1.posX, var1.posY + 30.0D, var1.posZ);
        GL11.glPopMatrix();
    }
