...
public class RenderHostEye extends RenderMinecartMobSpawner
{
    public RenderHostEye(ModelMinecart ms, float f)
    {
        super(ms, f);
        this.j = ms;
    }
    ...
    {
        return setSliderEyeBrightness((EntityHostEye)entityliving, i, f);
    }
}
