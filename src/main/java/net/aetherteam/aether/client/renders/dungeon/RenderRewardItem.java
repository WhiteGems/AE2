...
public class RenderRewardItem extends RenderManager
{
    ...
    {
        if (!rewardItem.getPlayerName().equalsIgnoreCase(Minecraft.getMinecraft().thePlayer.bS))
        {
            return;
        }
        ...
        {
            GL11.glPushMatrix();
            float f2 = shouldBob() ? MathHelper.sin((rewardItem.age + par9) / 10.0F + rewardItem.hoverStart) * 0.1F + 0.1F : 0.0F;
            float f3 = ((rewardItem.age + par9) / 20.0F + rewardItem.hoverStart) * (180F / (float)Math.PI);
            ...
            if (!ForgeHooksClient.renderEntityItem(rewardItem, itemstack, f2, f3, this.random, this.b.e, this.c))
            {
                ...
                else if (itemstack.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    for (int k = 0; k < itemstack.getItem().getRenderPasses(itemstack.getItemDamage()); k++)
                    {
                        ...
                        if (this.renderWithColor)
                        {
                            ...
                            renderDroppedItem(rewardItem, icon, b0, par9, f5 * f8, f4 * f8, f6 * f8);
                        }
                        else
                        {
                            renderDroppedItem(rewardItem, icon, b0, par9, 1.0F, 1.0F, 1.0F);
                        }
                    }
                }
                else
                {
                    ...
                    if (this.renderWithColor)
                    {
                        ...
                        float f4 = 1.0F;
                        renderDroppedItem(rewardItem, icon1, b0, par9, f8 * f4, f9 * f4, f5 * f4);
                    }
                    else
                    {
                        renderDroppedItem(rewardItem, icon1, b0, par9, 1.0F, 1.0F, 1.0F);
                    }
                }
            }
    ...
    private void renderDroppedItem(EntityRewardItem par1EntityRewardItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
        ...
        if (par2Icon == null)
        {
            par2Icon = this.b.e.b(par1EntityRewardItem.getEntityItem().getItemSpriteNumber());
        }
        ...
        if (this.b.l.fancyGraphics)
        {
            ...
            {
                GL11.glRotatef(((par1EntityRewardItem.age + par4) / 20.0F + par1EntityRewardItem.hoverStart) * (180F / (float)Math.PI), 0.0F, 1.0F, 0.0F);
            }

            float f12 = 0.0625F;
            float f11 = 0.021875F;
            ItemStack itemstack = par1EntityRewardItem.getEntityItem();
    ...
    {
        doRenderItem((EntityRewardItem)par1Entity, par2, par4, par6, par8, par9);
    }
