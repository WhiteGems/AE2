...
public class GuiDonatorMoa extends GuiScreen
{
    ...
    public void drawScreen(int x, int y, float partialTick)
    {
        ...
        if (this.donator != null)
        {
            ...
            overrideButton = new GuiButton(2, this.xParty + 10, this.yParty, 80, 20, this.choice != null ? (this.choice.getOverrideAll() ? "全部" : (this.choice.getOverridingColour() != null ? this.choice.getOverridingColour().name + " 恐鸟皮肤" : "无")) : "无");
        }
