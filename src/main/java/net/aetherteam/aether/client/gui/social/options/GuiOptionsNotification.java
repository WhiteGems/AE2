...
public class GuiOptionsNotification extends GuiScreen
{
    ...
    public GuiOptionsNotification(EntityPlayer var1, GuiScreen var2)
    {
        this.parent = var2;
        this.player = var1;
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        String var9 = AetherOptions.getShowNotifications() ? "True" : "False";
        GuiButton var10 = new GuiButton(1, this.xParty - 60, this.yParty - 36 - 28, 120, 20, "Show Receiving: " + var9);
        this.buttonList.add(var10);
        this.mc.renderEngine.resetBoundTexture();
        String var11 = "Notifications";
