...
public class GuiPartyEdit extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.k.add(new GuiButton(5, this.xParty - 60, this.yParty + 12 - 28, 120, 20, "Save"));
        this.k.add(new GuiButton(3, this.xParty - 60, this.yParty - 36 - 28, 120, 20, "Change Name"));
        this.k.add(new GuiButton(2, this.xParty - 60, this.yParty - 14 - 28, 120, 20, "Manage Permissions"));
        this.k.add(new GuiButton(1, this.xParty - 60, this.yParty + 8 - 28, 120, 20, "Manage Members"));
    ...
    protected void actionPerformed(GuiButton btn)
    {
        switch (btn.id)
        {
            ...
            case 1:
                this.g.displayGuiScreen(new GuiManageMembers(this.player, this));
                break;

            case 3:
                this.g.displayGuiScreen(new GuiEditPartyName(this.player, this));
                break;
    ...
    public void drawScreen(int x, int y, float partialTick)
    {
        ...
        this.k.add(this.typeButton);
        this.k.add(new GuiButton(3, this.xParty - 60, this.yParty - 36 - 28, 120, 20, "Change Name"));
        this.k.add(new GuiButton(1, this.xParty - 60, this.yParty - 14 - 28, 120, 20, "Manage Members"));
        this.k.add(new GuiButton(0, this.xParty - 60, this.yParty + 81 - 28, 120, 20, "Back"));
        ArrayList partyList = PartyController.instance().getParties();
