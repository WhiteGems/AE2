...
public class GuiOptions extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button)
    {
        ...
        switch (button.id)
        {
            ...
            case 1:
                this.g.displayGuiScreen(new GuiOptionsParty(this.player, this));
                break;

            case 2:
                this.g.displayGuiScreen(new GuiOptionsNotification(this.player, this));
                break;

            case 3:
                this.g.displayGuiScreen(new GuiOptionsCoinbar(this.player, this));
        }
    }
    ...
    public void drawScreen(int x, int y, float partialTick)
    {
        ...
        List playerList = this.g.thePlayer.theWorldClient.c;
        boolean online = playerList.size() > 1;
        this.k.add(new GuiButton(1, this.xParty - 60, this.yParty - 36 - 28, 120, 20, "Party HUD"));
        this.k.add(new GuiButton(2, this.xParty - 60, this.yParty - 14 - 28, 120, 20, "Notifications"));
        this.k.add(new GuiButton(3, this.xParty - 60, this.yParty + 8 - 28, 120, 20, "Coinbar"));
