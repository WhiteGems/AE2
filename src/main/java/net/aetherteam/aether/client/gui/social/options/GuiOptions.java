...
public class GuiOptions extends GuiScreen
{
    ...
    public GuiOptions(EntityPlayer var1, GuiScreen var2)
    {
        this.parent = var2;
        this.player = var1;
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        String var9 = "Options";
        this.drawString(this.fontRenderer, var9, var4 + 70 - this.fontRenderer.getStringWidth(var9) / 2, var5 + 5, 16777215);
        this.buttonList.add(new GuiButton(0, this.xParty - 60, this.yParty + 81 - 28, 120, 20, "Back"));
