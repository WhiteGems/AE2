...
{
    private static final ResourceLocation TEXTURE_BUTTONS = new ResourceLocation("aether", "textures/menu/aether2_buttons.png");
    private int color;
    private int color2;
    ...
    public void drawButton(Minecraft minecraft, int i, int j)
    {
        if (this.drawButton)
        {
            ...
            if (this.color != 0 || this.color2 != 0)
            {
                if (flag)
                {
                    this.drawString(fontrenderer, this.displayString, this.xPosition + this.width / 10 + this.scrollHeight - 80, this.yPosition + (this.height - 8) / 2, this.color);
                }
                else
                {
                    this.drawString(fontrenderer, this.displayString, this.xPosition + this.width / 10 + this.scrollHeight - 80, this.yPosition + (this.height - 8) / 2, this.color2);
                }
            }
        }
    }
