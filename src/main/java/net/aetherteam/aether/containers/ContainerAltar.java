...
public class ContainerAltar extends Container
{
    ...
    public ContainerAltar(InventoryPlayer inventoryplayer, TileEntityAltar tileentityaltar)
    {
        ...
        addSlotToContainer(new Slot(tileentityaltar, 0, 56, 17));
        addSlotToContainer(new Slot(tileentityaltar, 1, 56, 53));
        addSlotToContainer(new SlotFurnace(inventoryplayer.player, tileentityaltar, 2, 116, 35));
