        ...
        else
        {
            ...
            if (var4 != null)
            {
                ...
                if (var4.entityHit != null && this.onHitTarget(var4.entityHit))
                {
                    ...
                    {
                        var23 = (new CustomDamageSource("dart", this, this)).setDeathMessage(" 膝盖中了一飞镖").setProjectile();
                    }
                    else
                    {
                        var23 = (new CustomDamageSource("dart", this, this.shooter)).setDeathMessage(" 死于 " + this.shooter.getEntityName() + " 的飞镖").setProjectile();
                    }
