...
public class AetherSoundLoader
{
    ...
    public void onSound(SoundLoadEvent event)
    {
        ...
        registerSound(event.manager, "aemob/labyrinthsEye/cogloss.ogg", "/resources/newsound/aemob/labyrinthsEye/cogloss.ogg");
        registerSound(event.manager, "aemob/labyrinthsEye/eyedeath.ogg", "/resources/newsound/aemob/labyrinthsEye/eyedeath.ogg");
        registerSound(event.manager, "aemob/labyrinthsEye/move_1.ogg", "/resources/newsound/aemob/labyrinthsEye/move_1.ogg");
        registerSound(event.manager, "aemob/labyrinthsEye/move_2.ogg", "/resources/newsound/aemob/labyrinthsEye/move_2.ogg");
