...
public class GuiViewNotification extends GuiScreen
{
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        this.drawString(this.fontRenderer, name, this.width / 2 - this.fontRenderer.getStringWidth(name) / 2, centerX + 7, 16777215);
        String var8 = this.notification.getTypeContents().getTitle(this.notification);
        this.mc.renderEngine.resetBoundTexture();
        this.drawString(this.fontRenderer, var8, this.width / 2 - this.fontRenderer.getStringWidth(var8) / 2, centerX + 27, 16777215);
        ...
        for (int var11 = 0; var11 < var10.size(); ++var11)
        {
            ...
            this.mc.renderEngine.resetBoundTexture();
            this.drawString(this.fontRenderer, var12, this.width / 2 - this.fontRenderer.getStringWidth(var12) / 2, centerX + 45 + var11 * 10, 16777215);
        }
