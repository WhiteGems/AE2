...
import net.aetherteam.aether.interfaces.AEBlock;
...
public class AetherBlocks
{
    ...
    {
        for (Field f : AetherBlocks.class.getDeclaredFields())
        {
            AEBlock ann = (AEBlock)f.getAnnotation(AEBlock.class);
